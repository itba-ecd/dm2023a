...
ksemillas  <- c(700007, 707007, 707707, 777707, 777777) #reemplazar por las propias semillas
...
setwd("/Users/gabrieljoaquin/Library/CloudStorage/OneDrive-Personal/Gabos Popurri/ITBA MDC/05. Data Mining")  #Establezco el Working Directory
#cargo los datos
