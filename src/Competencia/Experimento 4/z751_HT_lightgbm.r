...
PARAM  <- list()
PARAM$experimento  <- "HT7510COMP10"

PARAM$exp_input  <- "TS7410COMP10"

PARAM$lgb_crossvalidation_folds  <- 5  #En caso que se haga cross validation, se usa esta cantidad de folds

PARAM$lgb_semilla  <- 700007   #cambiar por su propia semilla
...
PARAM$bo_iteraciones  <- 5  #iteraciones de la Optimizacion Bayesiana
