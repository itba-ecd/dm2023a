...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950COMP10"
PARAM$exp_input  <- "HT7510COMP10"

PARAM$modelos_rank  <- c( 7 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 50   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 700007  # se utiliza para generar el vector de  PARAM$semillerio  semillas
